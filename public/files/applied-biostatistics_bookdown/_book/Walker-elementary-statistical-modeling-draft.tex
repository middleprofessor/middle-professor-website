...
frequency of positives. This differs from the the Type I error rate,
which is the frequency of false positives dived by the frequency of
tests \emph{in which the null is true}. This frequency depends on the
frequency of nulls that are true.
