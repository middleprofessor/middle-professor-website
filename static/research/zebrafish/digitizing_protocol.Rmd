...
8. Go to menu item Analyze > Set Scale
9. Insert the distance in the “Know Distance” box (2nd from top)
10. Look at the Scale at the bottom. It will say something like “29.006 pixels/unit”. This is the scale.
...
16. Digitize 10-12 points from the tip of the snout to the end of the vertebral column
17. The points have to be **in order** from snout to tail -- don't insert a point in between other points
18. The points should be along the **midline** 1/2way between each lateral edge of the fish
