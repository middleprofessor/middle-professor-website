...
Add a ``load-packages'' chunk. You do not need to preface
``load-packages'' with ``data''. This is done here because chunk names
cannot be repeated in a single compiled object and I have a .Rmd file
for each chapter of the book and each begins with a chunk like this. So
I start the name of chunks within each chapter with a descritor of the
chapter.
