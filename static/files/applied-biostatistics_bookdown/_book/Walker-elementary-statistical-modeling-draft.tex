...
\section{This book is a path to many
doors}\label{this-book-is-a-path-to-many-doors}
...
\item
  ...
  of models, yet almost all methods used by researchers in biology are
  generalizations of what is known as the linear model\footnote{or,
    general linear model, but this gets confusing since the acronym
    (GLM) is mostly used for a class of statistical models called
    generalized linear models, which are extensions of the linear model}.
  All of these models look something like this
\end{enumerate}
...
which is a type of \textbf{model specification}. The meaning of each of
the lines will be disussed in chapter 1.
...
Because all linear models and their extensions are generalizations of
the specification in step one above, a modeling strategy of statistical
analysis is more coherent than a ``dichotomous key'' or ``table of
hypothesis tests'' strategy common to many textbooks.

Generalizations of the basic linear model in step one above include
linear mixed models, generalized linear models, generalized additive
models, causal graphical models, multivariate models, and machine
learning. This book is a path \emph{of elements} leading you to the
doors to each of these methods.
...
## (Intercept) 11.331730 0.3632787  9 31.192941 1.753900e-10
## XWT         -1.057625 0.4678365  9 -2.260673 5.012143e-02
\end{verbatim}
