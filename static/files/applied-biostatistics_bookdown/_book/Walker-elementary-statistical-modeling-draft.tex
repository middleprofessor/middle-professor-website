...
\CommentTok{# change factor levels for analysis aesthetics}
...
\NormalTok{dt <-}\StringTok{ }\NormalTok{urchin1[, .SD, .SDcols=}\KeywordTok{c}\NormalTok{(}\StringTok{"Resp"}\NormalTok{, }\StringTok{"Temp"}\NormalTok{, }\StringTok{"CO2"}\NormalTok{)]}
\NormalTok{dt <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(dt[Temp}\OperatorTok{==}\StringTok{"-"} \OperatorTok{&}\StringTok{ }\NormalTok{CO2}\OperatorTok{==}\StringTok{"-"}\NormalTok{][}\DecValTok{1}\OperatorTok{:}\DecValTok{2}\NormalTok{,],}
\NormalTok{            dt[Temp}\OperatorTok{==}\StringTok{"+"} \OperatorTok{&}\StringTok{ }\NormalTok{CO2}\OperatorTok{==}\StringTok{"-"}\NormalTok{][}\DecValTok{1}\OperatorTok{:}\DecValTok{2}\NormalTok{,],}
\NormalTok{            dt[Temp}\OperatorTok{==}\StringTok{"-"} \OperatorTok{&}\StringTok{ }\NormalTok{CO2}\OperatorTok{==}\StringTok{"+"}\NormalTok{][}\DecValTok{1}\OperatorTok{:}\DecValTok{2}\NormalTok{,],}
\NormalTok{            dt[Temp}\OperatorTok{==}\StringTok{"+"} \OperatorTok{&}\StringTok{ }\NormalTok{CO2}\OperatorTok{==}\StringTok{"+"}\NormalTok{][}\DecValTok{1}\OperatorTok{:}\DecValTok{2}\NormalTok{,]}
\NormalTok{            )}
\NormalTok{fit_dummy <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(Resp }\OperatorTok{~}\StringTok{ }\NormalTok{Temp}\OperatorTok{*}\NormalTok{CO2, }\DataTypeTok{data=}\NormalTok{dt)}
\NormalTok{model_matrix <-}\StringTok{ }\KeywordTok{model.matrix}\NormalTok{(fit_dummy)}
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(model_matrix)}
\end{Highlighting}
\end{Shaded}
...
1a. \textbf{file name}: ``canegrub\_feedingtrial.csv'' 1b. \textbf{file
name}: ``treatments.csv'' 2. \textbf{source}:
