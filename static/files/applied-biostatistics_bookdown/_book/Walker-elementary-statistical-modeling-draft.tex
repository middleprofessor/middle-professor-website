...
\emph{X} is classical ``t-test'' or
``ANOVA''}{A linear model with a single, categorical X is classical t-test or ANOVA}}\label{a-linear-model-with-a-single-categorical-x-is-classical-t-test-or-anova}
...
and zero otherwise. This is called dummy coding or treatment coding.
