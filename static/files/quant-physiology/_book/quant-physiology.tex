...
What is the epected time of diffusion of different molecules at
different scales?. The approximate expected time (t) is a function of
the distance (x) and the diffusion coefficient (D) and is given by the
approximation
