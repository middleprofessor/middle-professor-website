...
1. Professional APC presents antigen to naive Th cell using MHC-II. This is signal 1
...
1. Professional APC presents antigen to naive Tc cell using MHC-I. This is signal 1
...
1. T-cell dependent activation:
    ...
    *A second set of proteins (one on Th cell, one on B cells) bind. This is signal 2
    *Th cell secretes cytokins. This is signal 3.
